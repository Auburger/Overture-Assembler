...
A while ago, I got really into a game called Turing Complete. Basically, it's a game where you see that the NAND gate is Turing complete in and of itself by building your own 8-bit computer from the gate level up, making everything from the other logic gates to a flip flop, an ALU, and pretty much everything else you need.
